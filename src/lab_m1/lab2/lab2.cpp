...
void Lab2::Init()
{
    ...
    // by definition!
    {
        ...
        vector<VertexFormat> vertices
        {
            ...
            //  Point 1
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0, 1, 1), glm::vec3(1, 0, 1)),

            //  Point 2
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0, 1, 1), glm::vec3(1, 1, 0)),

            //  Point 3
            VertexFormat(glm::vec3(-1, 0, 0), glm::vec3(0, 1, 1), glm::vec3(0, 1, 1)),
        };

        vector<unsigned int> indices =
        {
            0, 2, 1,    // indices for first triangle
            3, 0, 1,    // indices for second triangle
            1, 2, 3,    // indices for third triangle
            3, 2, 0     // indices for fourth triangle
    ...
    // opposing vertex orientations.
    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(1, 0, 1), glm::vec3(0, 1, 1), glm::vec3(0, 1, 1))
        };
...

    {
        ...
        vector<VertexFormat> vertices
        {
            //  Point 0 (apex)
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(0, 1, 1), glm::vec3(1, 0, 0)),
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(0, 1, 1), glm::vec3(0, 1, 0)),
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(0, 1, 1), glm::vec3(1, 0, 1)),

            //  Point 1
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0, 1, 1), glm::vec3(1, 0, 0)),
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0, 1, 1), glm::vec3(0, 1, 0)),
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0, 1, 1), glm::vec3(0, 0, 1)),

            //  Point 2
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0, 1, 1), glm::vec3(1, 0, 0)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0, 1, 1), glm::vec3(1, 0, 1)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0, 1, 1), glm::vec3(0, 0, 1)),

            //  Point 3
            VertexFormat(glm::vec3(-1, 0, 0), glm::vec3(0, 1, 1), glm::vec3(1, 0, 1)),
            VertexFormat(glm::vec3(-1, 0, 0), glm::vec3(0, 1, 1), glm::vec3(0, 1, 0)),
            VertexFormat(glm::vec3(-1, 0, 0), glm::vec3(0, 1, 1), glm::vec3(0, 0, 1))
        };
        ...
        vector<unsigned int> indices =
        {
            ...
            10, 1, 4,   // indices for second triangle
            5, 8, 11,   // indices for third triangle
            9, 7, 2     // indices for fourth triangle
        };

        // Actually create the mesh from the data
        CreateMesh("tetrahedron_plain", vertices, indices);
    }
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["tetrahedron"], shaders["VertexNormal"], glm::vec3(0, 0, 0), glm::vec3(1.5f));
    RenderMesh(meshes["tetrahedron_plain"], shaders["VertexNormal"], glm::vec3(-2.5f, 0, 0), glm::vec3(1));

    // TODO(student): Draw the square
    RenderMesh(meshes["square"], shaders["VertexNormal"], glm::vec3(3, 0, 0), glm::vec3(2));
