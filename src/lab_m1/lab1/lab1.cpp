...
void Lab1::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes[shape_names[shape]], glm::vec3(-1, 0.5f, 0));

    RenderMesh(meshes["archer"], archer_position, glm::vec3(0.01f));
